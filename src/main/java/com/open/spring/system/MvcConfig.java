...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(@NonNull CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("https://spring.opencodingsociety.com", "https://open-coding-society.github.io", "http://127.0.0.1:4100", "http://localhost:4100").allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS")
        .allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS");


        // registry.addMapping("/socket.io").allowedOrigins("https://spring.opencodingsociety.com", "https://open-coding-society.github.io", "http://127.0.0.1:4100", "http://localhost:4100").allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS")
        // .allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS");
